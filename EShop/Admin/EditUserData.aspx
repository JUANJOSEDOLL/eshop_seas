<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditUserData.aspx.cs" Inherits="EShop.Admin.EditUserData" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 <h2><%: Title %>.</h2>
    <p class="text-danger">
        <asp:Literal runat="server" ID="ErrorMessage" />
    </p>
 <%--   <asp:TextBox ID="txtDataEmail" runat="server" ></asp:TextBox>--%>
  <%--  <asp:Button ID="Button1" runat="server" OnClick="LoadClientData" Text="Buscar cliente"/>--%>
        ...
        <hr />
         ...
         <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button runat="server" OnClick="UpdateUserToAdmin_Click" Text="Otorgar rol de administrador a este usuario" CssClass="btn btn-default"  Width="300px"/>
            </div>
        </div>
