<%@ Page Title="Administrar cuenta" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="EShop.Account.Manage" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-horizontal">
                <asp:HyperLink NavigateUrl="/Client/EditUserData" Visible="true" ID="HyperLink1" runat="server"><h4>Editar datos usuario</h4></asp:HyperLink>
                <hr />
