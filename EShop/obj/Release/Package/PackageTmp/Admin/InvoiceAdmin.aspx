<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InvoiceAdmin.aspx.cs" Inherits="EShop.Admin.InvoiceAdmin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 <asp:Label ID="txtCorreo" runat="server"  Visible="false"/>
...
<h1>FACTURA</h1>
    ...
    <asp:Table ID="TableClient" runat="server" Width="190mm">
       <asp:TableRow runat="server">
            ...
            <asp:TableCell runat="server" BorderStyle="None" Height="5mm" HorizontalAlign="Center" ColumnSpan="4"></asp:TableCell></asp:TableRow><asp:TableRow runat="server" Width="190mm">
            <asp:TableCell runat="server" BorderStyle="None"  Height="5mm" HorizontalAlign="Left" ColumnSpan="4">DETALLE DE PEDIDO</asp:TableCell>
        </asp:TableRow>
    </asp:Table>
        
        
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="190mm">
             <Columns>
