...
{
	[TestClass]
	public class CartItemTest1
        {
        [TestMethod]

        public void AddTest()
            {
            //Crea una lista de 3 items con precio y cantidad y comprueba que se calcule el IVA del carrito correctamente
            //Arrange            
            ...
            //Comprueba que el importe del IVA sea el correcto esperado de 21
            //Assert

            Assert.AreEqual(manager.GetAll().Sum(x=>x.Quantity*x.ProductPrice)*0.21, 21);
